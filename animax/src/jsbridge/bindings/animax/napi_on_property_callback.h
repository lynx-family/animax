...
// clang-format off
#ifndef ANIMAX_ANIMAX_SRC_JSBRIDGE_BINDINGS_ANIMAX_NAPI_ON_PROPERTY_CALLBACK_H_
#define ANIMAX_ANIMAX_SRC_JSBRIDGE_BINDINGS_ANIMAX_NAPI_ON_PROPERTY_CALLBACK_H_
...
namespace lynx {
namespace animax {
extern const uint64_t kNapiOnPropertyCallbackClassID;

class NapiOnPropertyCallback {
 public:
  NapiOnPropertyCallback(Napi::Function callback);

  NapiOnPropertyCallback(const NapiOnPropertyCallback& cb) = delete;

  void Invoke(bool arg0, int32_t arg1) {
    bool valid;
    ...
    Napi::Value arg1_errorType;
    arg1_errorType = Napi::Number::New(env, arg1);

    // The JS callback object is stolen after the call.
    binding::CallbackHelper::Invoke(std::move(cb), result_, exception_handler_, { arg0_success, arg1_errorType });
  }
...
#endif  // ANIMAX_ANIMAX_SRC_JSBRIDGE_BINDINGS_ANIMAX_NAPI_ON_PROPERTY_CALLBACK_H_
