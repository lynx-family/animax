...
#ifndef ANIMAX_SRC_MODEL_SHAPE_REPEATER_MODEL_H_
#define ANIMAX_SRC_MODEL_SHAPE_REPEATER_MODEL_H_
...
class RepeaterModel : public ContentModel {
 public:
  RepeaterModel(std::string name, std::unique_ptr<AnimatableFloatValue> copies,
 ...
 private:
  friend class RepeaterContent;

  std::unique_ptr<AnimatableFloatValue> copies_;
...
#endif  // ANIMAX_SRC_MODEL_SHAPE_REPEATER_MODEL_H_
