...
#ifndef ANIMAX_SRC_CONTENT_SHAPE_ELLIPSE_CONTENT_H_
#define ANIMAX_SRC_CONTENT_SHAPE_ELLIPSE_CONTENT_H_
...
class EllipseContent : public AnimationListener, public Content {
 public:
  EllipseContent(BaseLayer& layer, CircleShapeModel& model);
 ...
 private:
  ...
  CircleShapeModel& circle_shape_;
...
#endif  // ANIMAX_SRC_CONTENT_SHAPE_ELLIPSE_CONTENT_H_
