...
#ifndef ANIMAX_SRC_VIDEO_WEB_VIDEO_SHADER_WEB_H_
#define ANIMAX_SRC_VIDEO_WEB_VIDEO_SHADER_WEB_H_
...
class VideoShaderWeb : public VideoShaderGL {
 public:
  VideoShaderWeb() = default;
  ~VideoShaderWeb() override;
...
#endif  // ANIMAX_SRC_VIDEO_WEB_VIDEO_SHADER_WEB_H_
