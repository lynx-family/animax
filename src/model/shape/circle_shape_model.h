...
#ifndef ANIMAX_SRC_MODEL_SHAPE_CIRCLE_SHAPE_MODEL_H_
#define ANIMAX_SRC_MODEL_SHAPE_CIRCLE_SHAPE_MODEL_H_
...
#endif  // ANIMAX_SRC_MODEL_SHAPE_CIRCLE_SHAPE_MODEL_H_
