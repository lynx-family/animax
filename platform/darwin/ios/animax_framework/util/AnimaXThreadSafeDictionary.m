...
@implementation AnimaXThreadSafeDictionary {
...
- (BOOL)isEqualToDictionary:(NSDictionary *)otherDictionary {
  ...
  if ([otherDictionary isKindOfClass:AnimaXThreadSafeDictionary.class]) {
    AnimaXThreadSafeDictionary *other = (id)otherDictionary;
    BOOL isEqual;
    [_lock lock];
    [other->_lock lock];
...
- (BOOL)isEqual:(id)object {
  ...
  if ([object isKindOfClass:AnimaXThreadSafeDictionary.class]) {
    AnimaXThreadSafeDictionary *other = object;
    BOOL isEqual;
    [_lock lock];
    [other->_lock lock];
    isEqual = [_dic isEqual:other->_dic];
